...
public class MainActivity extends AppCompatActivity {
    ...
    float percentage = 0;
    float tipTotal = 0;
    float finalBillaAmount = 0;

    float DEFAULT_TIP_PERSENTAGE = 15;
    float REGULAR_TIP_PERCENTAGE = 10;
    float EXCELLENT_TIP_PERSENTAGE = 20;
    ...
    private void setTipValues() {
        ...
        tvBillTotalAmount.setText(getString(R.string.main_msg_billtotalresult, finalBillaAmount));
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.ibGoodService:
                percentage = DEFAULT_TIP_PERSENTAGE;
                break;
            case R.id.ibExcellentService:
                percentage = EXCELLENT_TIP_PERSENTAGE;
                break;
        }
        calculateFinalBill();
        setTipValues();
    ...
    private void calculateFinalBill(){
        ...
        finalBillaAmount = totalBillAmount + tipTotal;
    }
}
